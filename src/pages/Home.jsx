...
import {
  Map, CreditCard, 
  Train, Navigation, Smartphone, 
  MapPin, Globe,
  ChevronRight, Play, Route, Ticket,
  TicketCheck,
  ArrowRight
} from 'lucide-react'
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    document.title = 'Delhi Metro - Official Route Planner, Map, Fares & Station Information | DMRC Guide';
    
    // Meta Description - optimized for "delhi metro" search
    const metaDescription = document.querySelector('meta[name="description"]');
    const description = 'Delhi Metro - Complete guide with route planner, interactive metro map, 289 stations, real-time tracking, fare calculator & smart card info. Navigate Delhi Metro easily with official DMRC information.';
    if (metaDescription) {
    ...
    const keywords = [
      ...
      'Delhi Metro', 'DMRC', 'My Delhi Metro', 
      'Delhi Metro official website', 'Delhi Metro online',
      
      // Route & Journey Planning
      'Delhi Metro route planner', 'Metro route finder Delhi', 
      'Delhi Metro journey planner', 'Metro route calculator Delhi',
      'How to reach by Delhi Metro', 'Delhi Metro directions',
      'Best metro route Delhi', 'Shortest metro route Delhi',
      'Metro route suggestion Delhi', 'Delhi Metro travel planner',
      
      // Lines & Stations
      'Delhi Metro lines', 'Metro lines in Delhi', 
      'All Delhi Metro lines', 'Delhi Metro line map',
      'Delhi Metro station list', 'Metro stations in Delhi',
      'Delhi Metro stations near me', 'Nearest metro station Delhi',
      'Metro station finder Delhi', 'Delhi Metro station guide',
      
      // Maps & Navigation
      'Delhi Metro map', 'Metro map Delhi', 
      'Delhi Metro route map', 'Metro network map Delhi',
      'Interactive Delhi Metro map', 'Delhi Metro digital map',
      'Delhi Metro map download', 'Metro map PDF Delhi',
      'Delhi Metro offline map', 'Metro navigation Delhi',
      
      // Fares & Tickets
      'Delhi Metro fare', 'Metro fare calculator Delhi',
      'Delhi Metro ticket price', 'Metro fare chart Delhi',
      'Delhi Metro fare calculator', 'Metro ticket cost Delhi',
      'Delhi Metro smart card', 'Metro card recharge Delhi',
      'Delhi Metro token', 'Metro ticket booking Delhi',
      'Delhi Metro online ticket', 'Metro e-ticket Delhi',
      
      // Timing & Schedule
      'Delhi Metro timing', 'Metro timing today Delhi',
      'Delhi Metro first train', 'Metro last train Delhi',
      'Delhi Metro schedule', 'Metro train frequency Delhi',
      'Delhi Metro Sunday timing', 'Metro holiday timing Delhi',
      'Delhi Metro peak hours', 'Metro off-peak hours Delhi',
      
      // Real-time Information
      'Delhi Metro live status', 'Metro live tracking Delhi',
      'Delhi Metro real-time', 'Metro train live position',
      'Delhi Metro delay', 'Metro service status Delhi',
      'Delhi Metro updates', 'Metro news Delhi',
      
      // Airport Connectivity
      'Delhi Metro to airport', 'Metro to IGI Airport',
      'Airport Express Delhi', 'Delhi Metro airport line',
      'Metro to Terminal 3', 'Metro to Terminal 1',
      'Delhi Airport metro', 'Metro from airport Delhi',
      
      // Tourist & Places
      'Delhi Metro tourist guide', 'Metro to tourist places Delhi',
      'Delhi Metro to historical sites', 'Metro to Red Fort',
      'Metro to India Gate', 'Metro to Qutub Minar',
      'Metro to Lotus Temple', 'Metro to Akshardham',
      'Metro to Chandni Chowk', 'Metro to Connaught Place',
      'Delhi sightseeing by metro', 'Metro tourism Delhi',
      
      // NCR Connectivity
      'Delhi Metro to Noida', 'Metro to Gurgaon Delhi',
      'Delhi Metro to Faridabad', 'Metro to Ghaziabad',
      'Metro to Dwarka', 'Metro to Rohini',
      'Delhi Metro NCR network', 'Metro intercity Delhi',
      
      // Features & Facilities
      'Delhi Metro AC', 'Metro coach facilities',
      'Delhi Metro wifi', 'Metro charging points',
      'Delhi Metro security', 'Metro CCTV surveillance',
      'Delhi Metro women coach', 'Metro priority seating',
      'Delhi Metro parking', 'Metro feeder bus service',
      
      // Smart Features
      'Delhi Metro app', 'Metro mobile app Delhi',
      'Delhi Metro digital payment', 'Metro QR code ticket',
      'Delhi Metro UPI payment', 'Metro contactless card',
      'Delhi Metro smart features', 'Metro technology Delhi',
      
      // Lines Specific Keywords
      'Red Line Delhi Metro', 'Yellow Line Delhi Metro',
      'Blue Line Delhi Metro', 'Green Line Delhi Metro',
      'Violet Line Delhi Metro', 'Pink Line Delhi Metro',
      'Magenta Line Delhi Metro', 'Orange Line Delhi Metro',
      'Airport Express Line', 'Grey Line Delhi Metro',
      'Aqua Line Noida', 'Rapid Metro Gurgaon',
      
      // Popular Stations
      'Rajiv Chowk metro station', 'Kashmere Gate metro',
      'New Delhi metro station', 'Central Secretariat metro',
      'Hauz Khas metro station', 'Dwarka metro station',
      'Noida Sector 52 metro', 'Gurgaon metro stations',
      'Interchange stations Delhi', 'Major metro stations Delhi',
      
      // Planning & Information
      'Delhi Metro guide', 'Metro travel tips Delhi',
      'Delhi Metro for beginners', 'Metro first time user Delhi',
      'Delhi Metro rules', 'Metro regulations Delhi',
      'Delhi Metro dos and don\'ts', 'Metro etiquette Delhi',
      
      // Services
      'Delhi Metro customer care', 'Metro helpline Delhi',
      'Delhi Metro lost and found', 'Metro complaint Delhi',
      'Delhi Metro feedback', 'Metro suggestion Delhi',
      
      // Accessibility
      'Delhi Metro for disabled', 'Metro wheelchair access',
      'Delhi Metro senior citizen', 'Metro for elderly',
      'Delhi Metro elevator', 'Metro escalator facilities',
      
      // Environmental
      'Delhi Metro eco-friendly', 'Metro green initiative',
      'Delhi Metro solar power', 'Metro energy efficient',
      
      // Safety
      'Delhi Metro safety', 'Metro emergency procedures',
      'Delhi Metro fire safety', 'Metro security measures',
      
      // Future & Expansion
      'Delhi Metro Phase 4', 'New metro lines Delhi',
      'Delhi Metro expansion', 'Future metro projects Delhi',
      'Delhi Metro under construction', 'Upcoming metro stations',
      
      // Comparison & Reviews
      'Delhi Metro vs other metros', 'Metro rating Delhi',
      'Delhi Metro reviews', 'Metro user experience Delhi',
      
      // Business & Commute
      'Delhi Metro for office goers', 'Metro business travel',
      'Delhi Metro daily commute', 'Metro for students',
      'Delhi Metro rush hours', 'Metro crowd management',
      
      // Events & Special
      'Delhi Metro during festivals', 'Metro special trains',
      'Delhi Metro Republic Day', 'Metro Independence Day',
      'Delhi Metro for events', 'Metro to stadiums',
      
      // Technical
      'Delhi Metro speed', 'Metro train specifications',
      'Delhi Metro technology', 'Metro train maintenance',
      
      // Historical
      'Delhi Metro history', 'Metro development timeline',
      'Delhi Metro inauguration', 'Metro milestones',
      
      // Awards & Recognition
      'Delhi Metro awards', 'Metro achievements Delhi',
      'Delhi Metro world record', 'Metro international recognition',
      
      // Financial
      'Delhi Metro revenue', 'Metro ticket sales',
      'Delhi Metro budget', 'Metro project cost',
      
      // Employment
      'Delhi Metro jobs', 'Metro career opportunities',
      'Delhi Metro recruitment', 'Metro staff training',
      
      // COVID Measures
      'Delhi Metro COVID rules', 'Metro sanitization',
      'Delhi Metro mask rules', 'Metro social distancing',
      
      // Night Services
      'Delhi Metro night service', 'Metro late night',
      'Delhi Metro extended hours', 'Metro 24x7 proposal',
      
      // Integration
      'Delhi Metro bus integration', 'Metro auto rickshaw',
      'Delhi Metro taxi service', 'Metro last mile connectivity',
      
      // International
      'Delhi Metro for tourists', 'Metro foreign visitors',
      'Delhi Metro English guide', 'Metro multilingual signs'
    ].join(', ');
    ...
    const ogTags = [
      { property: 'og:title', content: 'Delhi Metro | Official Route Planner & Metro Guide | DMRC' },
      { property: 'og:description', content: 'Plan your Delhi Metro journey with our interactive route planner, real-time train tracking, fare calculator and complete metro guide.' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:title', content: 'Delhi Metro | Smart Route Planner & Real-time Guide' },
      { name: 'twitter:description', content: 'Navigate Delhi Metro with ease. Real-time routes, fare calculator, and everything you need for a seamless journey across Delhi NCR.' },
    ...
    schemaScript.textContent = JSON.stringify({
      ...
      "description": "Official Delhi Metro route planner with real-time information, fare calculator, and complete metro guide",
  ...
  const startCounters = () => {
    ...
    const updateCounters = () => {
      ...
      const newCounters = targetValues.map((target, index) => {
        if (index === 3) { // Daily Riders (decimal)
    ...
    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
      ...
      <div className="lg:w-1/2">
        ...
        <p className="text-gray-300 text-[16px] mb-8 max-w-lg">
          Plan your journey with the fastest <strong>Delhi Metro Route Planner</strong>. 
          Find routes between all 289 DMRC stations, check the Delhi Metro map,
          calculate metro fares, explore interchange stations and view metro
          timings across 12 metro lines including Blue Line, Yellow Line,
          Pink Line and Magenta Line.
        </p>
  ...
  <div className="hidden">
    ...
    <Link to="/metro-timings">Delhi Metro Timings</Link>
      ...
      <section className="py-6 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Delhi Metro Service Status</h2>
              <p className="text-gray-600 max-w-2xl">Real-time information about all Delhi Metro lines and stations. Check the current status of 12 metro lines operating across Delhi NCR.</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
              Explore the busiest and most important metro stations across Delhi NCR network.
            </p>
          </div>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-8 mb-8">
                <p className="text-gray-700 leading-relaxed mb-6">
                  <strong>Delhi Metro</strong> is one of the world's largest rapid transit systems, serving the National Capital Region with 12 metro lines, 289 stations, and a network spanning over 390 kilometers. Whether you're a daily commuter using the Delhi Metro route planner or a tourist exploring iconic landmarks, our comprehensive Delhi Metro guide helps you navigate the system efficiently.
                </p>
              </div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The Delhi Metro network consists of 12 operational lines connecting all major areas. Each line is color-coded for easy identification. From the Red Line to the Aqua Line, Delhi Metro serves millions of commuters daily. Our interactive Delhi Metro map shows real-time station locations and line information.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Use our advanced Delhi Metro route planner to find the fastest path between any two stations. Get instant information about travel time, number of stops, interchange details, and real-time train availability. Whether you need to reach the airport, office, or tourist destinations, our route planner calculates the best option for you.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Delhi Metro fares are distance-based, starting from ₹10 for short distances. Get exact fare information with our fare calculator. Smart Card users enjoy a 10% discount on all journeys and faster entry through dedicated gates. Plan your journey with fare information for both token and smart card options.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Monitor real-time Delhi Metro train positions and receive live status updates on all metro lines. Our service status dashboard shows current operations, delays, and special announcements. Get instant notifications about train frequency and accessibility information.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Explore Delhi's iconic landmarks via Metro. From Red Fort and India Gate to Lotus Temple and Qutub Minar, Delhi Metro provides easy access to major tourist attractions. Our guide includes travel times, station information, and directions to help you plan your sightseeing tour efficiently.
              </p>

              <div className="bg-blue-100 border-l-4 border-blue-600 p-6 my-8">
                <h4 className="font-bold text-gray-900 mb-2">Pro Tip:</h4>
                <p className="text-gray-700">Download our app for offline Delhi Metro maps, digital smart cards, real-time tracking, and detailed station information. Perfect for first-time users and regular commuters.</p>
              </div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Delhi Metro operates from 5:00 AM to 11:30 PM on all days. Check our guide for complete timing details, first and last train schedules, peak hour information, and special timings during festivals and national holidays.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="lg:w-1/2">
                ...
                <p className="text-gray-600 mb-6">
                  Download our app for real-time updates, digital tickets, and smart route planning on the go.
                </p>
                    ...
                    <div className="bg-gradient-to-b from-blue-500 to-cyan-500 rounded-[32px] overflow-hidden">
                      <div className="bg-white p-6">
                        <div className="text-center mb-6">
                          <div className="text-lg font-bold text-gray-900">Metro Guide</div>
                          <div className="text-xs text-gray-500">Delhi Metro Official</div>
                        </div>
                        
                        <div className="space-y-4">
                          <div className="bg-gray-50 rounded-xl p-4">
                            <div className="text-sm text-gray-600 mb-1">Next train to</div>
                            <div className="font-bold text-gray-900">Huda City Center</div>
                            <div className="text-xs text-blue-600 mt-1">Platform 2A • 4 mins</div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="bg-blue-50 rounded-lg p-3 text-center">
                              ...
                              <div className="font-bold text-blue-600">28 min</div>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div itemScope itemType="https://schema.org/WebPage">
        ...
        <meta itemProp="description" content="Official Delhi Metro route planner with real-time information and complete metro guide" />
      </div>
