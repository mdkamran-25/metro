  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Contact Delhi Metro Guide - Get customer support, file complaints, and send feedback. DMRC helpline, email, and office details available.",
      );
    } else {
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Delhi Metro contact, DMRC helpline, Metro customer care, Metro feedback, Metro complaints, Metro support, Delhi Metro phone number, Metro email, Metro office address, Metro customer service, Metro lost and found, Metro suggestions",
      );
    } else {
      const meta = document.createElement("meta");
      meta.name = "keywords";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({
        ...
        error: true,
        message:
          "❌ Failed to send message. Please try again or email us directly at feedback@dmrc.org",
      });
    }
  };
  ...
  const socialMedia = [
    {
      name: "Twitter",
      handle: "@OfficialDMRC",
      url: "https://twitter.com/OfficialDMRC",
      icon: <Twitter className="h-5 w-5" />,
      color: "text-blue-400",
    },
    {
      name: "Facebook",
      handle: "/DelhiMetroOfficial",
      url: "https://facebook.com/DelhiMetroOfficial",
      icon: <Facebook className="h-5 w-5" />,
      color: "text-blue-600",
    },
    {
      name: "Instagram",
      handle: "@delhimetrorail",
      url: "https://instagram.com/delhimetrorail",
      icon: <Instagram className="h-5 w-5" />,
      color: "text-pink-500",
    },
    {
      name: "YouTube",
      handle: "Delhi Metro Rail",
      url: "https://youtube.com/c/DelhiMetroRail",
  ...
  const quickLinks = [
    {
      ...
      action: () => alert("Redirecting to Lost & Found page"),
    },
    {
      title: "Feedback",
    ...
    {
      title: "Complaints",
      description: "Register complaints online",
      icon: <AlertCircle className="h-5 w-5" />,
      action: () => alert("Redirecting to Complaints portal"),
    },
    {
      title: "Suggestions",
      description: "Suggest improvements",
      icon: <Zap className="h-5 w-5" />,
      action: () => alert("Opening suggestions form"),
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "You can file complaints through our helpline 155370, email feedback@dmrc.org, or at any station's customer care desk. We resolve most issues within 48 hours.",
    },
    {
      question: "Where can I find lost property?",
      answer:
        "Lost property is kept at the station where it was found for 48 hours. Contact the station manager or check our online lost property portal for items lost more than 2 days ago.",
    },
    {
      question: "How do I apply for a concession card?",
      answer:
        "Concession forms are available at all stations. Submit with required documents and photographs at the customer care center. Processing takes 3-5 working days.",
    },
    {
      question: "Can I suggest a new station or route?",
      answer:
        "Yes! We welcome suggestions for new routes and stations. Use the contact form above or write to planning@dmrc.org with detailed proposals.",
    },
  ];
      ...
      <div className="w-[95%] mx-auto md:px-4">
        ...
        <div className="text-center mb-8 relative">
          ...
          <div className="relative">
            ...
            <p
              className="text-md md:text-xl text-gray-600 max-
            w-3xl mx-auto"
            >
              We're here to help with any questions, feedback, or concerns about
              Delhi Metro services. Your satisfaction is our priority.
            </p>
          </div>
        </div>
                ...
                {contactMethods.map((method, index) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div
                        className={`${method.color} text-white p-4 rounded-xl shadow`}
                      >
                        {method.icon}
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {method.features.map((feature, idx) => (
                            <span
                              key={idx}
                              className="text-xs bg-white/50 px-2 py-1 rounded-md text-gray-700"
                            >
                              {feature}
                            </span>
                          ))}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Please include relevant details like station names, card
                      numbers, or specific dates if applicable.
                    </p>
                  </div>
                  ...
                  <p className="text-sm text-center text-gray-500">
                    ...
                    <strong>surajsingh26574@gmail.com</strong>
                  </p>
                </form>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-700 mb-4">
                      For emergencies, security concerns, or immediate
                      assistance at stations, contact station control room or
                      dial:
                    </p>
              ...
              <div className="mt-8 bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {socialMedia.map((social, index) => (
                    ...
                    >
                      <div
                        className={`${social.color} mb-3 flex justify-center`}
                      >
                        {social.icon}
                      </div>
