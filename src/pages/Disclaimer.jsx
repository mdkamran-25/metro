...
const Disclaimer = () => {
  useEffect(() => {
    // SEO: Mark Disclaimer as noindex - legal disclosure pages not meant for search rankings
    // Conserves crawl budget for high-value content pages
    // Prevents duplicate content issues with similar legal disclaimers
    ...
    document.title = "Disclaimer - Delhi Metro Guide | Important Notice";
  }, []);
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-orange-800">
                  ...
                  the Delhi Metro Rail Corporation (DMRC) or any government
                  authority.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                Delhi Metro Guide is designed to provide helpful information
                about the Delhi Metro system, including route planning, fare
                estimates, station details, and tourist information. Our
                platform serves as a{" "}
                <span className="font-semibold">guidance tool only</span>.
              </p>
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-blue-800">
                  <span className="font-semibold">Important:</span> Always
                  verify metro schedules, fares, and routes from official DMRC
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                about the Delhi Metro, we cannot guarantee:
              </p>
              ...
              <div className="flex items-start gap-3 bg-yellow-50 p-4 rounded-lg">
                ...
                <p className="text-yellow-800">
                  ...
                  The Delhi Metro network spans across 12 lines, covering
                  approximately 392 kilometers with 288 stations (including the
                  Airport Express line). Information is subject to change as the
                  network expands.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                Delhi Metro Guide operates independently and has no official
                connection with:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              ...
              <p className="text-gray-700">
                Any reference to DMRC, Delhi Metro, or related entities is for
            ...
            <section>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4">
                <p className="text-red-800">
                  ...
                  practices of third-party websites. Accessing external links is
                  at your own risk.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border border-orange-200">
                <h4 className="font-bold text-gray-900 mb-3">
                  Important Safety Information for Delhi Metro Travelers:
                </h4>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2"></div>
                    <span>
                      Always follow safety instructions at metro stations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2"></div>
                  ...
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2"></div>
                    <span>
                      Report any suspicious activity to metro authorities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-orange-500 rounded-full mt-2"></div>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                To the fullest extent permitted by law, Delhi Metro Guide
                disclaims all liability for:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                <li>Any errors or omissions in the information provided</li>
                <li>
                  Delays, cancellations, or changes in Delhi Metro services
                </li>
                <li>
                  Financial losses or damages resulting from use of our
                  information
                </li>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <p className="text-gray-700 mb-4">
                  For accurate and official information about Delhi Metro,
                  please refer to:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-lg border">
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      ...
                      <li>
                        • Blue Line: Dwarka Sec 21 - Noida Electronic City
                      </li>
        ...
        <div className="mt-8 text-center">
          <div className="bg-gray-900 text-white p-6 rounded-2xl mb-6">
            <h3 className="text-xl font-bold mb-3">
              For Official Delhi Metro Information
            </h3>
            <p className="text-gray-300">
              Please visit the official Delhi Metro Rail Corporation website or
              contact their customer service for accurate, real-time
              information.
            </p>
            <a
          ...
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Delhi Metro Guide. This is an
            independent information service.
            <br />
            Delhi Metro and DMRC are registered trademarks of Delhi Metro Rail
            Corporation.
          </p>
        </div>
      </div>
