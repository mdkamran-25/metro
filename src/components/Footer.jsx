...
import { Train, Phone, Mail, MapPin, Facebook, Twitter, Youtube } from 'lucide-react'
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              ...
              connecting Delhi, NCR, and beyond with safe, efficient, and sustainable transportation.
            </p>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white">Metro Bhawan, Fire Brigade Lane, New Delhi - 110002</p>
                </div>
              </div>
            </div>
          </div>
