...
const NoidaCityCentreStation = lazy(() => import('./pages/NoidaCityCentreStation'))
...
function App() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main>
        {/* यहां LoadingSpinner का इस्तेमाल करें */}
        {/* <Suspense fallback={<LoadingSpinner type="metro" />}> */}
          <Routes>
            ...
            <Route path="/new-delhi-metro-station" element={<NewDelhiStation />} />
            <Route path="/kashmere-gate-metro-station" element={<KashmereGateStation />} />
            <Route path="/noida-city-centre-metro-station" element={<NoidaCityCentreStation />} />
